                        ...
                        <div class="row">
                            <div class="col-md-9">
                                ...
                                <div id="comment-section">
                                    ...
                                    <h2 style="margin-top: 30px;">Đánh giá</h2>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="rate rate_detail_company col-md-12" style="margin-left: 0%; margin-top: -30px;">
                                                    ...
                                                    <div class="content_comment flex position-relative">
                                                        <c:choose>
                                                            ...
                                                            <button class="btn_post_comment position-absolute" onclick ="javascript:addComment('${endpoint}', ${company.id}, ${user.candidate.id})">Đăng</button>
                                ...
                                <div id="contact-company">
                                    <h2 style="margin-top: 30px;">Liên hệ</h2>
...
<script type="text/javascript" src="https://res.cloudinary.com/dnlryecwq/raw/upload/v1662301033/comment_uismv6.js"></script>
