                                                    ...
                                                    <hr class="hr_signlog">
                                                        <div class="detail-infomation">
                                                            ...
                                                            <div class="detail-infomation-content">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <ul>
                                                                            <li><span>Ngành nghề:</span> <span><c:forEach items="${listmajorname}" var="m"><p style="margin-bottom: -15px !important;">${m[1]}.<p></c:forEach></span>
                                                                                </li>
                                                        ...
                                                        <div class="detail-job-more detail-job-content">
                                                            <div class="description-job">
                                                                ...
                                                                <p style="white-space: pre-line">${detailJob[19]}</p>
                                                            </div>
                                                            <div class="request-job">
                                                                <h5>Yêu cầu công việc</h5>
                                                                <p style="white-space: pre-line">${detailJob[22]}</p>
                                                            </div>
                                                            <div class="benefits-job">
                                                                <h5>Quyền lợi</h5>
                                                                <p style="white-space: pre-line">${detailJob[20]}</p>
                                                            </div>
