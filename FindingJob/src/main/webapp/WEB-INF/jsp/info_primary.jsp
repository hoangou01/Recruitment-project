...
<!--                        <P class="text-center notification">cap nhat thong tin </P>-->
                        ...
                        <form:input class="input_username update_inputname" value = "${candidate.fullname}" placeholder="Enter name" id="fullname" path = "fullname" required = "required"/> 
                        <label for="sdt"><b>Số điện thoại</b> <b class="text-danger">*</b></label>
                        <form:input value = "${candidate.phone}" class="input_username update_inputname" id="phone"  path = "phone"
