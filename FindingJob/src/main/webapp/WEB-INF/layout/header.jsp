                        ...
                        <ul class="cat-menu bg-dark">
                            <li class="dropdown-items"><a href="#" class="text-light">
                                ...
                                <div class="cat-menu__sub-menu">
                                    <div>
                                        <a href="<c:url value="/job-page"/>?city=HCM&major=0" class="cat-menu__sub-menu-item text-light">Hồ Chí Minh</a>
                                        <a href="<c:url value="/job-page"/>?city=Hà Nội&major=0" class="cat-menu__sub-menu-item text-light">Hà Nội</a>
                                        <a href="<c:url value="/job-page"/>?city=Đà Nẵng&major=0" class="cat-menu__sub-menu-item text-light">Đà Nẵng</a>
                                        <a href="<c:url value="/job-page"/>?city=all&major=0" class="cat-menu__sub-menu-item text-light">tất cả</a>
                                    </div>
                                </div>
                            </li>
                        </ul>
